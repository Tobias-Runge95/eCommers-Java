package com.ShopingCart.dreamshops.security.config;

import com.ShopingCart.dreamshops.security.jwt.AuthTokenFilter;
import com.ShopingCart.dreamshops.security.jwt.JwtAuthEntryPoint;
...
public class ShopConfig {
    ...
    private static final List<String> SECURED_URLS = List.of("/api/v1/carts/**", "/api/v1/cartItem");
